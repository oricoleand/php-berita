...
<head>
  ...
  <title>Dashboard | FiveGen.web.id</title>
...
<body class="hold-transition sidebar-mini">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php?page=home" class="brand-link">
      ...
      <span class="brand-text font-weight-light">FiveGen.web.id</span>
    </a>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=tampil-olahraga" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Olahraga</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-olahraga" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Tambah Olahraga</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=tampil-pendidikan" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Pendidikan</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-pendidikan" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=tampil-politik" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Politik</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-politik" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Tambah Politik</p>
                    </a>
                  </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <a href="index.php?page=tampil-teknologi" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Data Teknologi</p>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="index.php?page=tambah-teknologi" class="nav-link">
                      <i class="far fa-dot-circle nav-icon"></i>
                      <p>Tambah Teknologi</p>
                    </a>
                  </li>
                </ul>
              </li>
